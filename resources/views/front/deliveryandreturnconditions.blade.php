    ...
    <div class="container">
        <div class="row">
            <div class="card mt-5 bg-success text-white">
                ...
                <div class="card-body">
                    <p>Teslim Süresi: SİPARİŞİNİZİN KARGOYA VERİLME SÜRESİ EN FAZLA 3 İŞ GÜNÜDÜR.</p>

                    <p>3.2. Ödeme Şekli: Kredi Kartı</p>
                    ...
                    İade Prosedürü:</p>
                    <p>A) ALICI’nın cayma hakkını kullandığı durumlarda ya da siparişe konu olan ürünün çeşitli sebeplerle tedarik edilememesi veya hakem heyeti kararları ile ALICI’ya bedel iadesine karar verilen durumlarda, alışveriş kredi kartı ile ve taksitli olarak yapılmışsa, kredi kartına iade prosedürü aşağıda belirtilmiştir:</p>

                    <p>ALICI ürünü kaç taksit ile aldıysa Banka ALICI’ya geri ödemesini taksitle yapmaktadır. SATICI bankaya ürün bedelinin tamamını tek seferde ödedikten sonra, Banka poslarından yapılan taksitli harcamaların ALICI’nın kredi kartına iadesi durumunda, konuya müdahil tarafların mağdur duruma düşmemesi için talep edilen iade tutarları, yine taksitli olarak hamil taraf hesaplarına Banka tarafından aktarılır. ALICI’nın satış iptaline kadar ödemiş olduğu taksit tutarları ,eğer iade tarihi ile kartın hesap kesim tarihleri çakışmazsa her ay karta 1 (bir) iade yansıyacak ve ALICI iade öncesinde ödemiş olduğu taksitleri satışın taksitleri bittikten sonra , iade öncesinde ödemiş olduğu taksitleri sayısı kadar ay daha alacak ve mevcut borçlarından düşmüş olacaktır.
                    ...
                    <p>B) Kapıdan Ödeme ile Havale/EFT Ödeme Seçeneklerinde İade Prosedürü</p>

                   <p> Kapıdan ödeme ile havale/EFT ödeme seçeneklerinde iade Tüketiciden banka hesap bilgileri istenerek, Tüketicinin belirttiği hesaba (hesabın fatura adresindeki kişinin adına veya kullanıcı üyenin adına olması şarttır) havale ve EFT şeklinde yapılacaktır.</p>
                   ...
                   <p>Teslimat Adresi:</p>
                    ...
                    <p>i) Cep telefonu ürünlerinde sim kart takılması, WiFi ile network bağlantı kurulması halinde cihaz 2. el statüsüne geçmiş olacaktır. İlgili mevzuat gereği cayma hakkı kapsamında “ürünün satılabilir özelliğinin kaybolmaması” gerekmektedir. Bu nedenle de sim kart takılan veya WiFi ile bağlantı kurulan ürünler cayma hakkı kapsamında iade alınamamaktadır. Ayıplı vs. ürün olması halinde mağaza ile irtibata geçilmelidir. Mağaza, teknik servis raporu talep edebilir.</p>
                    <p>j) Niteliği itibarıyla iade edilemeyecek mal/hizmetler, hızla bozulan ve son kullanma tarihi geçen mal/hizmetler, tek kullanımlık mal/hizmetlerdir. Ayrıca, her türlü giyim ile kişisel bakım / kozmetik malzemelerinde cayma hakkının kullanılabilmesi için mal/hizmetin ambalajının açılmamış, bozulmamış ve kullanılmamış olmaları şartı bulunmaktadır.</p>
                    <p>k) Tüketicinin istekleri veya açıkça onun kişisel ihtiyaçları doğrultusunda hazırlanan, Niteliği itibarıyla iade edilemeyecek mal/hizmetler, çabuk bozulma tehlikesi olan veya son kullanma tarihi geçme ihtimali olan mal/hizmetler, tek kullanımlık mal/hizmetler, Cayma hakkı süresi sona ermeden önce, tüketicinin onayı ile hizmetin ifasına başlanan hizmet sözleşmeler, Fiyatı borsa veya teşkilatlanmış diğer piyasalarda belirlenen mallara ilişkin sözleşmeler, Gazete, dergi gibi süreli yayınların teslimine ilişkin sözleşmeler, Bahis ve piyangoya ilişkin hizmetlerin ifasına ilişkin sözleşmeler, Elektronik ortamda anında ifa edilen hizmetler ve tüketiciye anında teslim edilen gayri maddi mallara ilişkin sözleşmeler, Kopyalanabilir her türlü yazılım ve programlardır. Ayrıca, her türlü giyim ile kişisel bakım / kozmetik malzemelerinde cayma hakkının kullanılabilmesi için mal/hizmetin ambalajının açılmamış, bozulmamış ve kullanılmamış olmaları şartı bulunmaktadır.</p>
                </div>
            </div>
        </div>
    </div>
